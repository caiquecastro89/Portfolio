    ...
    <div style={{
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
        <a href="mailto:caique.castro89@gmail.com" style={{
          ...
          {!mobile && <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 12 }}>caique.castro89@gmail.com ↗</span>}
        </a>
        <a
        ...
        >
          <span>LinkedIn →</span>
          {!mobile && <span style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 12, color: BRAND.textMuted }}>linkedin.com/in/caique-castro89 ↗</span>}
        </a>
      </div>
    </div>
  )

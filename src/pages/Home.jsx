      ...
      <div style={{ paddingTop: mobile ? 56 : 64 }}>
        ...
        <section style={{ padding: mobile ? '24px 20px 20px' : '40px 56px 32px' }} id="work">
          ...
          <div className="rv" style={{
            ...
            <div style={{
              fontFamily: "Saans, system-ui, sans-serif", fontSize: mobile ? 9 : 11,
          ...
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {[
              ...
              <div key={svc.n} className="rv" style={{
                ...
                {!mobile && (
                  <span style={{
                    fontFamily: "Saans, system-ui, sans-serif", fontSize: '.63rem',
                ...
                <div>
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 6 }}>
                    {svc.tags.map(t => (
                      <span key={t} style={{
                        fontFamily: "Saans, system-ui, sans-serif", fontSize: mobile ? '.6rem' : '.7rem',
        ...
        <footer style={{
          ...
          <span style={{ fontFamily: "Saans, system-ui, sans-serif", fontSize: '.55rem', letterSpacing: '.1em', textTransform: 'uppercase', color: BRAND.textFaint }}>
      ...
      <CursorTooltip label="↗ VIEW CASE" onClick={onClick}>
        <div style={{ position: 'relative' }}>
          ...
          <div style={{
            ...
            fontFamily: "Saans, system-ui, sans-serif", fontSize: mobile ? 9 : 10,
